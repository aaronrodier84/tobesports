...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
	...
	/* ================== SeasonGames ================== */
	Route::resource(config('laraadmin.adminRoute') . '/seasongames', 'LA\SeasonGamesController');
	Route::get(config('laraadmin.adminRoute') . '/seasongame_dt_ajax', 'LA\SeasonGamesController@dtajax');
});
