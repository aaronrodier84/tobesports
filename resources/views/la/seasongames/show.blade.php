...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $seasongame->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("SeasonGames", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/seasongames/'.$seasongame->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("SeasonGames", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.seasongames.destroy', $seasongame->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/seasongames') }}" data-toggle="tooltip" data-placement="right" title="Back to SeasonGames"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'd_team1_id')
						@la_display($module, 'team1_id')
						@la_display($module, 'd_team2_id')
						@la_display($module, 'team2_id')
						@la_display($module, 'start_ts')
						@la_display($module, 'score1')
						@la_display($module, 'score2')
					</div>
				</div>
			</div>
		</div>
